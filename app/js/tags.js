riot.tag2('site', '<input type="text" class="site-root-url"> <input type="text" placeholder="login" class="site-un" value="{opts.login || \'\'}"> <input type="text" placeholder="password" class="site-pw" value="{opts.password || \'\'}"> <input type="text" placeholder="screenshot" class="site-filename-prefix" value="{opts.filename || \'screenshot\'}"> <input placeholder="1000" class="site-width" value="{opts.width || \'1000\'}" type="{\'number\'}"> <p class="site-output-path">{opts.outputFolder || \'\'}</p> <button id="savePath" onclick="{showDialog}">save to</button> <button id="submit" onclick="{startSpider}">begin spider</button>', '', '', function(opts) {
    var self = this;
